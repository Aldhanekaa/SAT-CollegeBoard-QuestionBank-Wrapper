...
export default function CardFlip({
  ...
  const cardColor =
    isVocabCard && difficulty ? getDifficultyColor(difficulty) : color;

  return (
    <div
      style={{
        ["--primary" as any]: cardColor ?? "#2563eb",
      }}
      className="group relative h-[400px] w-full  [perspective:2000px] cursor-pointer"
      onClick={() => {
    ...
    >
      ...
      >
        ...
        >
                  ...
                  {categories.length > 0 && (
                    <div className="flex flex-wrap justify-center gap-1 mt-4">
                      {categories.slice(0, 3).map((category, index) => (
                        <span
                          key={index}
                          className="text-xs text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded"
                        >
                          {category}
                        </span>
                      ))}
          ...
          {/* Bottom content - only for non-vocab cards */}
          {!isVocabCard && (
              ...
              <>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="from-primary via-primary/90 to-primary/80 flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br">
